...
public class AttendanceSessionController {
    ...
    @PostMapping("/start")
    public ResponseEntity<Map<String, Object>> startAttendanceSession(
        ...
        response.put("message", "Attendance session started for event: " + eventId);
    ...
    @PostMapping("/end")
    public ResponseEntity<Map<String, Object>> endAttendanceSession(
            @RequestBody Map<String, String> request,
            Authentication authentication) {
        String eventId = request.get("event_id");
        ...
        Map<String, Object> response = new HashMap<>();
        response.put("success", true);
        response.put("message", "Attendance session ended for event: " + eventId);
